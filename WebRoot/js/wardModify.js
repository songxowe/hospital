				...
				if (list.length > 0) {
					for (var i = 0; i < list.length; i++) {
						...
						var $tr = "<tr style='border-bottom:1px rgb(199,199,199) dashed;'>"+
							...
							"<a href='javascript:void(0);' onclick='modify_price1("+i+")' ><img src='ico/edit_remove.png' style='position:relative;left:-72px;top:5px;'></a>"+
							"<a href='javascript:void(0);' onclick='modify_price2("+i+")'><img src='ico/edit_add.png' style='position:relative;left:-15px;top:5px;'></a>"+
