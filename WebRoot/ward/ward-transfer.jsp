...
<body>
				...
				<tr>
					...
					<td>
						<p class="short-input ue-clear">
							<input type="search" readonly results="s" name="patinetId" id="patientId" />
						</p>
					</td>
					<td>
						<p class="short-input ue-clear">
	...
	<div  class="showPatientDialog">
		<iframe src="../patient_find.html" frameBorder="0" width="100%" scrolling="auto" height="100%"></iframe>
	</div>
</body>
...
<script type="text/javascript" src="../ward/wardTransfer.js"></script>
